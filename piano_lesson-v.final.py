...
########################## BUGGED, NEED TO FIX ###################################################
    ...
    def pageUpdate(self):
        self.label = Label(self, image=None, text="Click 'Next' to continue.")
...
class Freeplay(Lesson):
    def __init__(self):
        Lesson.__init__(self)
        self.label = Label(self, text="Welcome to Freeplay. Press 'Start Freeplay' to Begin\n"\
                               "and the 'F#' and 'C' keys to quit.")
        self.label.pack(side="top", fill="both", expand=True)
            ...
            while True:
                for i in range(len(self.switches)):
                    if GPIO.input(self.switches[i]) == True:                      
                        ...
                        if GPIO.input(self.switches[6]) == True and GPIO.input(self.switches[0]) == True:
                            breaker = True
                    else:
                ...
                if breaker:
                    ...
                    GPIO.output(self.leds[6], GPIO.LOW)
                    self.notes[0].stop()
                    self.notes[6].stop()
                    breaker = False
                    break
